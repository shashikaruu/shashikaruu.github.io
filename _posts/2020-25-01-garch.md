 ...
 * The effects of the external regressors are amplified under the
 ...
 | Resid | Resid^2
------------- | ------------- | -------------
Box-Pierce Test | X-squared= 19.7454 |  X-squared= 29.663
 | df=20 |  df=30
 | p-value=0.474 |  p-value= 0.483
 Box-Ljung Test | X-squared= 19.8241 |  X-squared= 29.8793
 | df=2 |  df=
  | p-value= 0.4125 |  p-value= 0.4718
 Jacque-Bera Normality Test | Test stat = 113.81 |
| p-value=0000 |
 ARCH effect test | | Chi-squared=7.6423
 | | Df=7
| | p-value=0.3652
